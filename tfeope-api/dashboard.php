...
$endpoints = [
    'CLIENT (public)' => [
        ['GET', '/api/public/home.php',                 'Public homepage payload'],
        ['GET', '/v1/client/auth/session.php',          'Current client auth session'],
        ['POST', '/v1/client/auth/login.php',           'Client sign in'],
        ['POST', '/v1/client/auth/signup.php',          'Client sign up'],
        ...
        ['GET', '/v1/client/clubs/get_all.php',        'Clubs listing'],
        ['GET', '/v1/client/appointed/get_all.php',    'Appointed officers'],
        ['GET', '/v1/client/past_leaders/get_all.php', 'Past leaders'],
        ...
        ['GET', '/v1/client/members/verify.php',       'Verify member by ID (requires sign-in)'],
        ['GET', '/members/member_search/?id={EAGLES_ID}', 'Member landing page (HTML, barcode target)'],
    ],
    'ADMIN (protected)' => [
        ['POST', '/api/admin/login.php',                'Admin sign in'],
        ['POST', '/api/admin/logout.php',               'Admin sign out'],
        ['GET',  '/api/admin/session.php',              'Current admin session'],
        ['GET',  '/api/admin/dashboard.php',            'Admin dashboard payload'],
        ['GET',  '/v1/admin/news/get_all.php',         'All news (draft + published)'],
        ['POST', '/v1/admin/news/create.php',          'Create news + upload image'],
        ['POST', '/v1/admin/news/update.php',          'Update news + image'],
        ...
        ['POST', '/v1/admin/videos/update.php',        'Update video + thumbnail'],
        ...
        ['POST', '/v1/admin/events/update.php',        'Update event + media'],
        ...
        ['POST', '/v1/admin/memorandum/update.php',    'Update memo + pages'],
        ...
        ['GET',  '/v1/admin/past_leaders/get_all.php', 'All past leaders'],
        ['POST', '/v1/admin/past_leaders/create.php',  'Create past leader'],
        ['POST', '/v1/admin/past_leaders/update.php',  'Update past leader'],
        ['POST', '/v1/admin/past_leaders/delete.php',  'Delete past leader'],
        ['POST', '/v1/admin/regions/create.php',       'Create region'],
        ['POST', '/v1/admin/clubs/create.php',         'Create club'],
        ['GET',  '/v1/admin/magna_carta/get_all.php',  'All Magna Carta items'],
        ['POST', '/v1/admin/magna_carta/create.php',   'Create Magna Carta item'],
        ['POST', '/v1/admin/magna_carta/update.php',   'Update Magna Carta item'],
        ...
        ['POST', '/v1/admin/members/import_csv.php',   'Bulk import members from CSV'],
        ['POST', '/v1/admin/members/delete.php',       'Delete member + pic'],
        ['GET',  '/v1/admin/users/get_all.php',        'All panel users'],
        ['POST', '/v1/admin/users/create.php',         'Create panel user'],
        ['POST', '/v1/admin/users/update.php',         'Update panel user'],
        ['POST', '/v1/admin/users/delete.php',         'Delete panel user'],
    ],
    'SYSTEM' => [
