...
function App() {
  ...
  const activeMemoPage =
    memoLightbox && memoLightbox.memo.pages
      ...
      : null
  const activeMemoPageUrl = typeof activeMemoPage === 'string'
    ? activeMemoPage
    : activeMemoPage?.url || null
  const activeMemoPageNumber = typeof activeMemoPage === 'object' && activeMemoPage
    ? activeMemoPage.pageNumber || memoLightbox?.index + 1 || 1
    : memoLightbox?.index + 1 || 1
  ...
  return (
    <>
      ...
      <div id="lightbox" className={memoLightbox ? 'is-open' : ''}>
        ...
        {memoLightbox && activeMemoPageUrl ? (
          <>
            ...
            <img src={activeMemoPageUrl} alt={memoLightbox.memo.title} />
            <div className="caption">
              {memoLightbox.memo.title} | Page {activeMemoPageNumber}
            </div>
